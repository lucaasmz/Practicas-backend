...
<body>
  ...
  <button type="submit"><a href="listar_nike.php">nike</a></button>
  <button type="submit"><a href="listar_mayora500.php">precio m 500</a></button>
  ...
  <section>
    <div class="container">
      <div class="row">
        ...
        mysqli_select_db($conexion, "stockropa");
        ...
        while ($reg = mysqli_fetch_array($datos)) {?>
          <div class="card col-sm-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/gettyimages-1199242002.jpg?crop=0.666xw:1.00xh;0.201xw,0&resize=480:*" alt="" width="100px" height="100px")>
