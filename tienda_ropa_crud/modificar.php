...
$consulta = "SELECT * FROM ropa WHERE codigo=$id";
...
<html lang="en">
    ...
    <body>
        ...
        if(array_key_exists('guardar_cambios',$_POST)){
            ...
            // a) generar la consulta a realizar
             $consulta = "UPDATE ropa SET tipo_prenda='$tipo_prenda', marca='$marca', talle='$talle', precio='$precio', imagen='$imagen' WHERE codigo =$id";
